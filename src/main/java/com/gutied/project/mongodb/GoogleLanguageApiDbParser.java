...
public class GoogleLanguageApiDbParser {
    ...
    public static List<DBObject> parseEntities (AnalyzeEntitiesResponse googleResponse) {
        ...
        for (Entity entity : googleResponse.getEntitiesList()) {
            ...
            entityDbObject.put(EntitiesCollectionKeys.offset.toString(), entity.getMentions(0).getText().getBeginOffset());
    ...
    public static DBObject parseSentiment (AnalyzeSentimentResponse googleResponse) {
        ...
        basicDBObject.put(SentimentCollectionKeys.magnitude.toString(), googleResponse.getDocumentSentiment().getMagnitude());
